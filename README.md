...
[![k3s](https://img.shields.io/badge/k3s-v1.26.1-green?style=for-the-badge)](https://k3s.io/)
...
- [ ] Upstream improvements to helm charts as outputs of security tool analysis
  ...
  - [ ] Kube-Bench
  - [ ] Polaris
- [ ] Fix up Thanos integration for storing data onto NAS
- [ ] Scrub out anything pseudo-sensitive
